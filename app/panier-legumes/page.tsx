...
export default function PanierLegumesPage() {
  ...
  const loadLegumes = async () => {
    try {
      ...
      setError('Impossible de charger les légumes.')
    } finally {
      setLoading(false)
    }
  }
          ...
          <section className="relative overflow-hidden h-screen flex items-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="container-custom relative z-10 w-full">
              <div className="text-center">
                ...
                >
                  <p className="text-xl text-white drop-shadow-lg">Chargement des légumes...</p>
                </motion.div>
              </div>
            </div>
          </section>
      ...
      <main className="pb-32 md:pb-24">
          ...
          <div className="container-custom relative z-10 w-full max-w-5xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl lg:text-3xl text-white/95 drop-shadow-lg mb-8 max-w-2xl mx-auto">
                Choisissez vos légumes frais et composez votre panier
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <AnimatePresence>
          {cart.length > 0 && (
            ...
            >
              {/* Fond avec effet glassmorphism transparent */}
                  ...
                  <div className="flex-1 w-full lg:w-auto">
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[#1a1a1a]/70">Livraison : {DELIVERY_LOCATION}</span>
                      </div>
                      ...
                      <div className={`flex items-center gap-1.5 ${isMinimumReached() ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <span className={`font-semibold ${isMinimumReached() ? '' : 'drop-shadow-sm'}`}>
                          {isMinimumReached() 
                            ...
                            : `Minimum : ${(MINIMUM_ORDER - getTotal()).toFixed(2)}€ restants`}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 text-center md:text-left">
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#1a1a1a]/70">{DELIVERY_LOCATION}</p>
                      </div>
                    </div>
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-3">
                      <div className="w-12 h-12 bg-green-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
                        {categoryLegumes.map((legume, index) => {
